    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 pb-8">
        <div className="grid grid-cols-12 gap-8">
          {/* Left Panel - Form */}
          <div className="relative col-span-4 rounded-lg overflow-hidden">
              ...
              <div className="flex justify-between items-center mb-6 border-b border-gray-300 py-1">
                ...
                <div className="flex items-center">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1 p-3 mr-2 rounded-lg text-sm font-medium text-gray-600 hover:bg-gray-50 transition-all ${
